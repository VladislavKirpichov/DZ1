...
// char is_less_or_eq(const char* ch1, const char* ch2) {
//     if (ch1 == ch2) return 1;
//
//     while (*ch1 <= *ch2) {
//         if (*ch1 < *ch2)
...
// }
//
// char is_more_or_eq(const char ch1[], const char ch2[]) {
//     if (ch1 == ch2) return 1;
//
//     while (*ch1 >= *ch2) {
//         if (*ch1 > *ch2)
...
// Quick Sort
// void sort_by_region(Skyscraper *skyscrapers, size_t start, size_t end) {
//     if (start >= end) return;
//
//     int leftPtr = start;
//     int rightPtr = end;
...
//         while (leftPtr < rightPtr && is_less_or_eq(skyscrapers[leftPtr].region, skyscrapers[end].region))
//             leftPtr++;
//
//         while (leftPtr < rightPtr && is_more_or_eq(skyscrapers[rightPtr].region, skyscrapers[end].region))
//             rightPtr--;
//
//         swap(skyscrapers + leftPtr, skyscrapers + rightPtr);
//     }
//
//     swap(skyscrapers + leftPtr, skyscrapers + end);
//     sort_by_region(skyscrapers, start, leftPtr - 1);
//     sort_by_region(skyscrapers, leftPtr + 1, end);
//
//     return;
// }
